...
project_root = Path(os.getcwd()).parent.parent.parent.parent.absolute()
...
project = 'Fashion Finder'
copyright = '2022, Mary Kate Durnan, Kyle Hrivnak, Jonathan Slack'
author = 'Mary Kate Durnan, Kyle Hrivnak, Jonathan Slack'
